...
public class Level_1 extends LevelTemplate {
    ...
    public void init() {
        ...
        Sprite sp4 = new SpriteAnimation("Sprite_walk.png", 1, 1, 32, 64, 0, 0,  100);
        Sprite sp5 = new SpriteAnimation("Sprite_walk.png", 1, 1, 32, 64, 0, 64,  100);
        Sprite sp6 = new SpriteAnimation("Sprite_walk.png", 1, 1, 32, 64, 0, 128,  100);
        Sprite sp7 = new SpriteAnimation("Sprite_walk.png", 1, 1, 32, 64, 0, 192,  100);
        ...
        setMap(Util.getUniqueID(), new TiledMap("testTMX.tmx"));
